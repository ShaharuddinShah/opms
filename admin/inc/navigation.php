...
<!-- Main Sidebar Container for Navigation  -->
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                    <a href="https://www.onlinegantt.com/#/gantt" target="_blank" class="nav-link nav-gantt">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>admin/?page=board" class="nav-link nav-board">
                    ...
                    <li class="nav-header">Reports</li>
                      ...
                      <li class="nav-item dropdown">
                        <a href="<?php echo base_url ?>admin/?page=reports/by_member" class="nav-link nav-reports_by_member">
                          <i class="nav-icon fas fa-user-tie"></i>
                          <p>
                            Rendered By Members
                          </p>
