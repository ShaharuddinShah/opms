...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title">Time Alloted for Member per Project</h3>
        ...
        <div class="container-fluid">
			<div class="row">
				...
				<div class="col-8">
					...
					<h3 class="text-center"><b>Time Allotted for Member for <?= $proj ?></b></h3>
			...
			<table class="table table-bordered table-hover table-striped">
				...
				<tbody>
					<?php 
						$i = 1;
						$total_dur = 0;
						$qry = $conn->query("SELECT * from `report_list` where member_id = '{$eid}' and project_id = '{$pid}' order by unix_timestamp(datetime_from) asc, unix_timestamp(datetime_to) asc ");
...
<script>
	$(document).ready(function(){
       ...
       $('#print').click(function(){
		   ...
		   var _h = $('head').clone()
		   var _el = $('<div>')
		   _h.find("title").text("Time Allotted By Member Per Project Report - Print View")
