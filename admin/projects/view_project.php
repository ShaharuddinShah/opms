    ...
    <div class="card card-outline card-navy shadow rounded-0">
        ...
        <div class="card-body">
            <div class="container-fluid">
                ...
                <h3 class="border-bottom"><b>Reports Submitted</b></h3>
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php 
                            $i = 1;
                            $qry = $conn->query("SELECT r.*, w.name as work_type, e.code as ecode, CONCAT(e.firstname,' ',e.middlename,' ', e.lastname) as fullname FROM `report_list` r inner join `work_type_list` w on r.work_type_id = w.id inner join member_list e on r.member_id = e.id where r.project_id = '{$id}' order by unix_timestamp(r.date_created) desc ");
