            ...
            <div class="container-fluid">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php 
                            $i = 1;
                            $qry = $conn->query("SELECT r.*, w.name as work_type FROM `report_list` r inner join `work_type_list` w on r.work_type_id = w.id where r.project_id = '{$id}' and r.member_id = '{$_settings->userdata('id')}' order by unix_timestamp(r.date_created) desc ");
