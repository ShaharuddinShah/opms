				...
				<tbody>
					<?php 
						...
						while($row = $qry->fetch_assoc()):
                            ...
                            $row['total_member'] = $conn->query("SELECT distinct(member_id) FROM `report_list` where project_id = '{$row['id']}'")->num_rows;
					?>
						<tr>
							...
							<td class=""><p class="m-0 truncate-1 text-right"><?php echo number_format($row['total_member']) ?></p></td>
