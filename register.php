      ...
      <div class="d-flex w-100 h-100 justify-content-center align-items-center">
        <div class="card col-lg-10 card-outline card-primary rounded-0 shadow">
          <div class="card-header rounded-0">
            <h4 class="text-dark text-center"><b>Create a New Admin Account</b></h4>
          </div>
            ...
            <form id="registration-frm" action="" method="post">
              ...
              <div class="row">
                    <div class="form-group col-md-10">
                      <input type="username" name="username" id="username" placeholder="user@email.com" required class="form-control form-control-sm form-control-border">
