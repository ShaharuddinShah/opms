...
<div class="row">
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-light shadow">
            ...
            <span class="info-box-number text-right">
                <?php 
                    echo $conn->query("SELECT * FROM `report_list` where member_id = '{$_settings->userdata('id')}'")->num_rows;
                ?>
            </span>
            </div>
            <!-- /.info-box-content -->
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-3">
        <div class="info-box bg-gradient-light shadow">
            ...
            <span class="info-box-number text-right">
                <?php 
                    echo duration($conn->query("SELECT sum(duration) FROM `report_list` where member_id = '{$_settings->userdata('id')}'")->fetch_array()[0]);
                ?>
            </span>
            </div>
            <!-- /.info-box-content -->
